...
By running `emri_demo.py <https://github.com/AI-HPC-Research-Team/GWAI/tree/main/demos/emri_demo.py>`_ script, a EMRIs waveform example is generated. 
...
You can adapt the configurations in `emri_demo.py <https://github.com/AI-HPC-Research-Team/GWAI/tree/main/demos/emri_demo.py>`_ according to your own needs.
...
1. Generate waveform by running `mbhb_demo.py <https://github.com/AI-HPC-Research-Team/GWAI/tree/main/demos/mbhb_demo.py>`_.
...
1. Generate waveform by running `sgwb_demo.py <https://github.com/AI-HPC-Research-Team/GWAI/tree/main/demos/sgwb_demo.py>`_.
2. Visulize the generated waveform by running ``plot_waveform.py`` (you only need to choose the corresponding GW source as shown below).
...
1. Generate waveform by running `vgb_demo.py <https://github.com/AI-HPC-Research-Team/GWAI/tree/main/demos/vgb_demo.py>`_.
2. Visulize the generated waveform by running ``plot_waveform.py`` (you only need to choose the corresponding GW source as shown below).
